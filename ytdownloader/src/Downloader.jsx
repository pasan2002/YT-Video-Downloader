...
export default function Download() {
    ...
    async function getVideoInfo(link) {
        try {
            ...
            const response = await fetch(
                `https://youtube-video-downloader-extension-1.onrender.com/api/v1/get-vid-info/${videoID}`
            );
            ...
            const durationResponse = await fetch(
                `https://youtube-video-downloader-extension-1.onrender.com/api/v1/get-video-duration/${videoID}`
            )
    ...
    function download(){
        ...
        const videoID = videoIDMatch[1]
        const url = `https://youtube-video-downloader-extension-1.onrender.com/video-download?id=${videoID}&resolution=${resolution}`

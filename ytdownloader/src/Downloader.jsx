...
export default function Download() {
    ...
    async function getVideoInfo(link) {
        try {
            ...
            const response = await fetch(
                `https://yt-video-downloader-gamma.vercel.app/api/v1/get-vid-info/${videoID}`
            );
            ...
            const durationResponse = await fetch(
                `https://yt-video-downloader-gamma.vercel.app/api/v1/get-video-duration/${videoID}`
            )
    ...
    function download(){
        ...
        const videoID = videoIDMatch[1]
        const url = `https://yt-video-downloader-gamma.vercel.app/video-download?id=${videoID}&resolution=${resolution}`
